...
SVC_NAME="actions.runner.JonnyGamer-JonnyGamer.github.io.super-playground-runner"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (JonnyGamer-JonnyGamer.github.io.super-playground-runner)"
